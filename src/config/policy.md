...
Members are provided with card access corresponding to the following doors.
...
All studio sessions need to be booked in advance.
**We operate a Microsoft SharePoint Calendar for each room** which users are given access to after completing the relevant inductions and the C4DM Studios Policy Agreement.

**Please do not book more than 3 consecutive days in any space without making a specific request to studio management.**
We often support longer term usage, but this may be supplemented with conditions to enable fair use of the spaces by others during that time.

Please use your bookings and avoid blocking the spaces if you do not need them.
**The cancellation of sessions should be processed at least 3 days in advance.**
If your scheduled sessions are regularly unused, we reserve the right to review your ability to make future bookings.
If you find that spaces are being booked but remain empty (and thus unusable), please report this issue to studio management.

**Please do not make bookings for others.**
We expect you to be in attendance during your booking, and are responsible for all participants involved in your session (for both security, and health and safety reasons).
...
- Studio fire extinguishers are located in G2 next to the Performance Lab doors, in the hallway outside the Control Room (G2C), and in the hallway outside the Listening/Live Room (G4). Fires in proximity to electrical equipment must be extinguished using carbon dioxide extinguishers.
- First aid kits are located in the Performance Lab (G2B) and the Live Room (G4).
- Emergency door releases should only be used in the event of fire, injury, or threat.
...
All equipment and other paraphernalia that is brought into the studios as part of a session must be removed from the studios when that session has concluded, unless given direct permission from studio management.

</details>

# Events

User are permitted to arrange public facing events within the studios, whereby an event is considered to be any session involving public invitation and/or non-participatory spectatorship.
This includes, but is not limited to, live music performances, open/lab seminars, workshops, hackathons and conferences.
Users wishing to arrange such an event must first complete a risk assessment, which is our standard procedure for ensuring proper health and safety standards.
**It is not permissible to schedule an event without first completing a risk assessment.**
...
Users are permitted to loan studio equipment for use outside of our facility, and can request this through Microsoft SharePoint.
...
By submitting the C4DM Studios Policy Agreement, you agree to the terms outlined in this document.
**These policies are mandatory for all users wishing to access the studio.**
After agreeing to these policies, users will be granted access to our facilities and be invited to join the C4DM Studios Members page on Microsoft SharePoint, where all of our resources, room bookings and equipment loans are managed.

This document ensures that all users of C4DM Studios follow the correct procedures, whilst maintaining a safe, respectful, and efficient working environment.
We retain the right to amend this agreement at any time, and will notify studio members when we do so.
Members are encouraged to read all updates to our studio policy, and we similarly encourage suggestions on how to improve our policy.
